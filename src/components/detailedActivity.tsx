...
import { DetailedActivity, SegmentEffort, Segment } from '../type';
import { getDetailedActivity } from '../selector/detailedActivity';
...
function mapStateToProps(state: any, ownProps: any) {
  ...
  const detailedActivity: DetailedActivity = getDetailedActivity(state, ownProps.params.id);
  const segmentEfforts = isNil(detailedActivity) ? null : detailedActivity.segmentEfforts;
  return {
