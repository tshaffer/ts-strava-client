...
import { DetailedActivity, DetailedActivityAttributes, SegmentEffort, DetailedActivityData, StravatronDetailedActivityAttributes, StravatronDetailedActivityData } from '../type';
  ...
  return (dispatch: any, getState: any): any => {
    ...
    axios.get(path)
      .then((response) => {
        ...
        const { detailedActivityAttributes, locationData, segments, detailedSegments, segmentEfforts, segmentEffortsInActivity } = detailedActivityData;
